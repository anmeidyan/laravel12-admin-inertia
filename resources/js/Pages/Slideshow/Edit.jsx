...
export default function Edit({ slideshow }) {
    const { data, setData, put, processing, errors, clearErrors } = useForm({
        is_active: slideshow.is_active,
        title: slideshow.title,
        description: slideshow.description,
        image_path: `${window.location.origin}${slideshow.image_path}`
    })
    ...
    function submit(e){
        ...
        put(`/admin-panel/slideshow/${slideshow.id}`, {
            preserveScroll: true
        })
    }
